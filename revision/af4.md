...
![alt text](/media/data/git/AF4/revision/img8.JPG "Arden")  **Règle de suppresion d'un état**
...
* On reduit les expressions rationnelles.

* On construit leurs Automates Minimal
